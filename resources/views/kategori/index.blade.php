    ...
    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
      ...
      <form action="#">
        <div class="sm:col-span-2">
          ...
          <div>
            <label for="iconEdit"
              class="block w-full text-left mb-2 text-sm font-medium text-gray-900 dark:text-white">Icon</label>

            <input
              class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
              aria-describedby="file_input_help" id="fotoEdit" type="file">
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">Hanya format PNG</p>
          </div>
      ...
      <form action="#">
        <div class="lg:col-span-1">
          <div class="flex flex-col items-center">
            <div
              class="w-32 h-32 rounded-lg overflow-hidden bg-gradient-to-br from-teal-400 to-teal-600 mb-4 shadow-lg flex justify-center items-center">
              <!-- <img src="https://dlcdnwebimgs.asus.com/gain/14730014-9B03-4369-83EE-B668F348B5AA" alt="Icon"
                class="w-full h-full object-cover"> -->
                <i class="fa-solid fa-laptop text-7xl"></i>
            </div>
          </div>
        </div>
        <div class="sm:col-span-2">
...
<body class="bg-gray-100 dark:bg-gray-900">
        ...
        <li>
          <a href="admin_GALLERY.html" class="flex items-center p-2 text-gray-300 rounded-lg hover:bg-blue-800 group">
            ...
            <span class="ml-3">Gallery</span>
                ...
                <li>
          <a href="admin_KATEGORI.html" class="flex items-center p-2 text-white rounded-lg bg-blue-700 hover:bg-blue-600 group">
  ...
  <div class="p-4 md:ml-64">
    <div class="p-4 mt-14">
      ...
      <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-6">Kategori</h1>

      <div class="bg-white rounded-lg shadow dark:bg-gray-800 p-6">
        <div class="p-4 border-b border-gray-200 dark:border-gray-700">
          <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white">
              <i class="fa-solid fa-list m-2"></i>Kategori
            </h2>
          ...
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 display" id="myTable">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              <tr>
                ...
                <th scope="col" classs="px-6 py-3">Icon</th>
            ...
            <tbody>
              <tr
                ...
                <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Laptop</td>
...
<!-- Harusnya disini ada create blade dan edit blade -->